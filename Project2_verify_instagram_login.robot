...
Verify Instagram Login
    ...
    Input Text       xpath=//*[@id="loginForm"]/div[1]/div[1]/div/label/input    #enter your username
    Input Password   xpath=//*[@id="loginForm"]/div[1]/div[2]/div/label/input    #enter your password 
